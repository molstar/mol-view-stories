...
addLabel(structure_1cdw,
  { label_asym_id: 'C', beg_label_seq_id: 160, end_label_seq_id: 177 },
  'TBP (H. sapiens)'
);
...
// Add label to A. thaliana TBP using a range to adjust font size
addLabel(structure_1vtl,
  { label_asym_id: 'E', beg_label_seq_id: 75, end_label_seq_id: 92 },
  'TBP (A. thaliana)'
);
