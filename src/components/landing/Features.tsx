    ...
    <section className='py-20 px-4 md:px-8 bg-background'>
      <div className='max-w-6xl mx-auto'>
        <div className='text-center mb-16'>
          <h2 className='text-4xl font-bold text-foreground mb-4'>Everything You Need to Tell Your Story</h2>
          <p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
            Powerful tools designed for scientists, educators, and storytellers who want to create compelling molecular
            narratives.
          </p>
        </div>
