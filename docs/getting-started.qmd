...
```{.molviewspec}
// Load a protein structure from the
// Protein Data Bank
const structure = builder
  .download({ url: 'https://www.ebi.ac.uk/pdbe/entry-files/download/1cbs_updated.cif' })
  .parse({ format: 'mmcif' })
...
- **[Core Features](core-features.qmd)** - Learn about advanced visualization options
- **[Tips & Shortcuts](tips-shortcuts.qmd)** - Discover efficient workflows
- **[Example Stories](example-stories/index.qmd)** - Study the pre-made examples for inspiration
